...
import { Loader2, TrendingUp, TrendingDown, DollarSign, Wallet, BarChart3 } from 'lucide-react'
...
export default function FinanceTab({ finance, loadingFinance, daysRange }: Props) {
  // FinanceTab — the original FinanceTab component
                ...
                <>
                  <ResponsiveContainer width="100%" height={240}>
                    <LineChart data={balanceChartData}>
                      ...
                      <YAxis tick={{ fontSize: 11 }} stroke="#bbb" tickFormatter={((v: number) => `¥${v}`) as any} />
