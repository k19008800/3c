...
afterAll(async () => {
  ...
  try {
    ...
    await db.delete(schema.adjustmentRecords).where(eq(schema.adjustmentRecords.requestedBy, requesterId));
    await db.delete(schema.adjustmentRecords).where(eq(schema.adjustmentRecords.requestedBy, approverId));
