...
import type { ApiKeyAuthResult } from "./types.js";
import { resetUsageStatsIfNeeded } from "./usage.service.js";
...
export class ApiKeyAuthService {
  ...
  async validateApiKey(
    ...
    // 4. 重置每日/每月使用统计（如果需要）
    await resetUsageStatsIfNeeded(key.id, key.lastResetDaily, key.lastResetMonthly);
