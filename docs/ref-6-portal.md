...
│ │ 数据库            | ✅ 正常 | 100%   | 5ms       | 低    │  │
│ │ 缓存服务          | ✅ 正常 | 100%   | 2ms       | 低    │  │
│ │ 渠道: OpenAI    | ✅ 正常 | 99.95% | 1.2s      | 正常  │  │
│ │ 渠道: DeepSeek  | ✅ 正常 | 99.98% | 0.8s      | 正常  │  │
│ │ 渠道: Anthropic | ✅ 正常 | 99.90% | 1.5s      | 正常  │  │
│ └──────────────────────────────────────────────────────────┘  │
│                                                                  │
│ ┌─ 历史记录 (最近 30 天) ─────────────────────────────────┐    │
│ │ 日期       | 事件              | 持续时间 | 解决时间    │    │
│ │───────────|───────────────────|---------|-------------│    │
│ │ 07-25     | 渠道 OpenAI 宕机 | 12 分钟  | 自动恢复   │    │
