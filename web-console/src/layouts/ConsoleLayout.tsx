...
const ADMIN_NAV: NavGroup[] = [
  { group: "客户管理", icon: "👥", items: [
    ...
    { to: "/admin/customers/detail", label: "客户详情", icon: "👤" },
    { to: "/admin/customers/credit", label: "额度管理", icon: "🪙" },
    { to: "/admin/real-name", label: "实名认证审核", icon: "🆔" },
    { to: "/admin/customers/apikey-security", label: "API Key 安全", icon: "🔑" },
    { to: "/admin/customers/tags", label: "客户标签管理", icon: "🏷️" },
    { to: "/admin/customers/lifecycle", label: "客户生命周期", icon: "📈" },
  ]},
  { group: "财务结算", icon: "💰", items: [
    { to: "/admin/finance", label: "财务工作台", icon: "🏦" },
    ...
    { to: "/admin/invoices", label: "发票审核", icon: "📄" },
    { to: "/admin/withdrawals", label: "提现管理", icon: "💳" },
    { to: "/admin/redemption", label: "兑换码管理", icon: "🎟️" },
    ...
    { to: "/admin/vendor-settlements", label: "结算对账", icon: "⚖️" },
    { to: "/admin/finance/profit", label: "利润分析", icon: "📈" },
    { to: "/admin/finance/pricing", label: "价格管理", icon: "🏷️" },
    { to: "/admin/finance/reconciliation-diff", label: "对账差异处理", icon: "🔍" },
  ...
  { group: "供应商管理", icon: "🔌", items: [
    { to: "/admin/vendors", label: "供应商列表", icon: "📋" },
    { to: "/admin/vendors/detail", label: "供应商详情", icon: "🔍" },
    { to: "/admin/vendors/model-service", label: "模型服务管理", icon: "🎛️" },
    { to: "/admin/vendors/multimodal", label: "多模态模型管理", icon: "🎨" },
    { to: "/admin/vendors/profiles", label: "厂商资料管理", icon: "🏢" },
    { to: "/admin/vendors/pricing", label: "厂商定价管理", icon: "💰" },
    { to: "/admin/vendors/cost", label: "供应商成本管理", icon: "📦" },
    { to: "/admin/vendors/stats", label: "用户选购统计", icon: "📊" },
    { to: "/admin/vendors/price-change", label: "价格变更通知", icon: "📢" },
    { to: "/admin/vendors/performance", label: "供应商绩效", icon: "🏆" },
    { to: "/admin/vendors/competitive", label: "竞品价格监控", icon: "📊" },
  ]},
  { group: "代理商管理", icon: "🤝", items: [
    { to: "/admin/agents", label: "代理商列表", icon: "📋" },
    { to: "/admin/agents/detail", label: "代理商详情", icon: "🔍" },
    { to: "/admin/agents/commission-config", label: "佣金配置", icon: "⚙️" },
    { to: "/admin/withdrawals", label: "提现记录", icon: "💳" },
    { to: "/admin/agents/approvals", label: "客户报备审核", icon: "✅" },
  ]},
  { group: "模型管理", icon: "🤖", items: [
    { to: "/admin/models", label: "模型市场", icon: "📈" },
  ]},
  { group: "营销推广", icon: "📢", items: [
    { to: "/admin/affiliate", label: "推荐返利", icon: "💰" },
    { to: "/admin/campaigns", label: "营销活动管理", icon: "🎪" },
  ]},
  { group: "工单客服", icon: "🎫", items: [
    { to: "/admin/tickets", label: "工单列表+处理", icon: "📋" },
    { to: "/admin/tickets/dispute", label: "消费纠纷处理", icon: "⚖️" },
  ]},
  { group: "系统设置", icon: "⚙️", items: [
    { to: "/admin/announcements", label: "公告管理", icon: "📢" },
    { to: "/admin/roles", label: "角色权限", icon: "🛡️" },
    { to: "/admin/i18n", label: "国际化翻译", icon: "🌐" },
    { to: "/admin/settings/notification-policy", label: "通知策略配置", icon: "🔔" },
    { to: "/admin/settings/operator-dashboard", label: "管理员工作量", icon: "📊" },
  ]},
  { group: "运维配置", icon: "🛠", items: [
    { to: "/admin/sys/config", label: "系统行为", icon: "⚡" },
    { to: "/admin/sys/monitoring", label: "监控与警报", icon: "🔔" },
    { to: "/admin/sys/performance", label: "性能配置", icon: "🐌" },
    { to: "/admin/sys/webhook-retry", label: "Webhook 重试", icon: "🔄" },
    { to: "/admin/sys/undo", label: "撤销操作日志", icon: "↩️" },
    { to: "/admin/sys/logs", label: "日志维护", icon: "📝" },
    { to: "/admin/sys/site", label: "站点设置", icon: "🌐" },
    { to: "/admin/sys/rate-limit", label: "限流设置", icon: "🚦" },
    { to: "/admin/email-templates", label: "邮件模板", icon: "📰" },
    { to: "/admin/sys/content", label: "内容管理", icon: "📄" },
  ]},
  { group: "审计合规", icon: "🔍", items: [
    ...
    { to: "/admin/audit/operation-diff", label: "操作差异对比", icon: "🔍" },
    { to: "/admin/data-requests", label: "政府数据调取", icon: "🏛️" },
  ]},
  { group: "风控合规", icon: "🚨", items: [
    ...
    { to: "/admin/risk/ip-blacklist", label: "IP黑名单管理", icon: "🌍" },
