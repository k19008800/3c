  ...
  return (
    <div>
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
        ...
        <HelpIcon helpKey="cost_dashboard" />
      </div>
      ...
      <div style={card}>
        <div style={{ fontWeight: 600, marginBottom: 12 }}>📉 各供应商成本占比 <HelpIcon helpKey="cost_dashboard" /></div>
        {costQ.isLoading ? <SkeletonGroup count={5} /> : (
