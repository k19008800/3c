  ...
  return (
    <div>
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
        ...
        <HelpIcon helpKey="vendor_performance" />
      </div>
      ...
      <div style={card}>
        <div style={{ fontWeight: 600, marginBottom: 12 }}>🏆 供应商绩效排名 <HelpIcon helpKey="vendor_performance" /></div>
        {perfQ.isLoading ? <SkeletonGroup count={5} /> : (
